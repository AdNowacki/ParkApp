...
<template>
  <FullScreenLayout>
    <div class="bg-white shadow-lg rounded-lg p-6 border border-gray-200 max-w-lg w-full mx-auto">
      ...
      <FormKit type="form" @submit="loginUserHandler" :actions="true">
        <template #submit>
          <button
            type="submit"
            class="bg-decor-300 hover:bg-decor-200 active:bg-decor-200 text-white font-semibold py-2 px-4 rounded shadow w-full mt-3"
          >
            {{ t('form.send') }}
          </button>
        </template>
